...
const features = [
  ...
  },
  {
    ...
    bgColor: "from-teal-50 to-blue-50 dark:from-teal-950/30 dark:to-blue-950/30",
    items: [
...
const faqItems = [
  {
    ...
    answer: "Evet, Sportiva tek bir hesapla farklı rollere geçiş yapmanıza olanak tanır. Hem bir spor salonunun sahibi, hem bir başka salonda eğitmen, hem de başka bir salonda üye olabilirsiniz."
  },
  {
    question: "Platformu kullanmak için ücret ödemem gerekiyor mu?",
    answer: "Sportiva temel özellikleri tüm kullanıcılar için ücretsizdir. Salon sahipleri ve eğitmenler için gelişmiş analitik ve yönetim araçları içeren premium paketlerimiz bulunmaktadır."
  },
  {
    question: "Kişisel verilerim güvende mi?",
    answer: "Sportiva'da veri güvenliği en önemli önceliğimizdir. En yüksek güvenlik standartları ve veri şifreleme teknikleriyle kişisel verilerinizi koruyoruz. Her kullanıcı kendi verileri üzerinde tam kontrol sahibidir."
  },
  {
    question: "Mobil cihazlardan da erişim sağlayabilir miyim?",
    answer: "Evet, Sportiva tamamen mobil uyumlu bir web uygulamasıdır. Ayrıca yakın zamanda iOS ve Android için native mobil uygulamalarımız da kullanıma sunulacaktır."
  }
];
...
export default function CtaSection() {
  ...
  // Işıltılı arka plan elementleri
  ...
  return (
    <section className="w-full py-24 lg:py-32 relative overflow-hidden">
      {/* Işıltılı parçacıklar */}
      <div className="absolute inset-0 opacity-50 dark:opacity-30 pointer-events-none overflow-hidden">
        {particles.map((particle) => (
          <motion.div
            key={particle.id}
            className="absolute rounded-full bg-indigo-200 dark:bg-indigo-700"
            style={{
              width: particle.size,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div>
              ...
              >
                Fitness sektöründe rekabette öne geçin. Tek platform üzerinden tüm spor salonu, 
                eğitmen ve üye ilişkilerini yönetin, hem zamandan hem de maliyetten tasarruf edin.
              </motion.p>
            </div>
            ...
            <div ref={featureListRef} className="space-y-3">
              {features[selectedRole].items.map((item, index) => (
                ...
                >
                  <div className={`flex-shrink-0 mt-1 w-5 h-5 rounded-full bg-gradient-to-r ${features[selectedRole].bgColor} flex items-center justify-center`}>
                    <CheckIcon className={`h-3 w-3 bg-gradient-to-r ${features[selectedRole].color} bg-clip-text text-transparent`} />
                  </div>
            ...
            >
              <Button asChild size="lg" className="group relative shadow-lg bg-gradient-to-r from-indigo-600 to-teal-600 hover:from-indigo-700 hover:to-teal-700 text-white border-none overflow-hidden">
              ...
              <Button asChild variant="outline" size="lg" className="group border-indigo-200 dark:border-indigo-800 hover:bg-indigo-50 dark:hover:bg-indigo-950/30">
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100 dark:border-gray-800 backdrop-blur-sm relative z-10 overflow-hidden">
              ...
              <h3 className="text-xl font-semibold mb-6 relative">Sık Sorulan Sorular</h3>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/30 rounded-xl p-5 relative overflow-hidden">
                    ...
                    <svg width="100%" height="100%" className="absolute inset-0">
                      <defs>
                        <pattern id="smallGrid" width="20" height="20" patternUnits="userSpaceOnUse">
                          <path d="M 20 0 L 0 0 0 20" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-indigo-500/30" />
                        </pattern>
                      </defs>
                  ...
                  <div className="relative z-10">
                    ...
                    <Button asChild variant="outline" className="w-full group bg-white/80 dark:bg-gray-800/80 border-indigo-200 dark:border-indigo-800">

...
import { UserCircle, Mail, LogOut, Palette, LayoutDashboard, Shield, Home } from "lucide-react";
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="bg-red-50 dark:bg-red-900/20 p-8 rounded-xl border border-red-200 dark:border-red-800 shadow-lg max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-center text-red-700 dark:text-red-400">Kullanıcı bulunamadı</h2>
          <p className="mt-4 text-center text-red-600 dark:text-red-300">Oturum süreniz dolmuş olabilir. Lütfen tekrar giriş yapın.</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      <div className="container mx-auto py-12 px-4">
        <div className="flex flex-col items-center mb-12">
          ...
          <div className="mt-2 text-gray-500 dark:text-gray-400">{user.email}</div>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 p-6">
            ...
            <div className="space-y-4">
              <div className="flex flex-col">
                <span className="text-sm text-gray-500 dark:text-gray-400 mb-1">Kullanıcı ID</span>
              ...
              <div className="flex flex-col">
                <span className="text-sm text-gray-500 dark:text-gray-400 mb-1">E-posta Adresi</span>
            ...
            <div className="mt-8 space-y-3">
              <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Hızlı İşlemler</h3>
              <Button onClick={() => router.push("/dashboard")} className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary">
